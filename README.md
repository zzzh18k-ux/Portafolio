...
<body class="min-h-screen">
    ...
    <section class="pt-32 pb-20 px-6">
        <div class="max-w-5xl mx-auto text-center">
            <p class="text-sm text-neutral-500 mb-4">Disponible para proyectos freelance</p>
            <h1 class="text-5xl md:text-7xl font-semibold tracking-tight mb-6">
                Editor de Video &<br>
                <span class="gold">Content Creator</span>
            </h1>
            <p class="text-neutral-400 max-w-xl mx-auto mb-10 text-lg">
                Transformo ideas en piezas visuales que conectan. Especializado en post-producción, motion graphics y color grading.
            </p>
            <div class="flex gap-4 justify-center">
                <a href="#work" class="px-6 py-3 bg-white text-black font-medium rounded-full hover:bg-neutral-200 transition-colors">
                    Ver trabajos
                </a>
                <a href="#contact" class="px-6 py-3 border border-neutral-700 rounded-full hover:border-neutral-400 transition-colors">
                    Contactar
                </a>
            </div>
        </div>
    ...
    <section id="work" class="py-20 px-6">
        <div class="max-w-5xl mx-auto">
            <div class="flex items-end justify-between mb-12">
                <h2 class="text-3xl font-semibold tracking-tight">Trabajos Seleccionados</h2>
            ...
            <div class="space-y-20">
                ...
                <div class="group cursor-pointer">
                    ...
                    <div class="flex items-start justify-between">
                        <div>
                            <h3 class="text-xl font-medium mb-1">Nike — Reel Deportivo</h3>
                ...
                <div class="group cursor-pointer">
                    ...
                    <div class="flex items-start justify-between">
                        <div>
                            <h3 class="text-xl font-medium mb-1">Neon Nights — Videoclip Musical</h3>
                ...
                <div class="group cursor-pointer">
                    ...
                    <div class="flex items-start justify-between">
                        <div>
                            <h3 class="text-xl font-medium mb-1">Tierra — Documental</h3>
    ...
    <!-- SOBRE MÍ -->
    <section id="about" class="py-20 px-6 border-t border-neutral-900">
        <div class="max-w-5xl mx-auto grid md:grid-cols-2 gap-16">
            <div>
                <h2 class="text-3xl font-semibold tracking-tight mb-6">Sobre mí</h2>
    ...
    <!-- CONTACTO -->
    <section id="contact" class="py-20 px-6 border-t border-neutral-900">
        <div class="max-w-5xl mx-auto text-center">
            <h2 class="text-3xl font-semibold tracking-tight mb-4">¿Tienes un proyecto?</h2>
            <p class="text-neutral-400 mb-10">Hablemos de cómo puedo ayudarte a llevarlo al siguiente nivel.</p>
            <div class="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
                <a href="mailto:contacto@alexvfx.com" class="px-8 py-4 bg-white text-black font-medium rounded-full hover:bg-neutral-200 transition-colors">
                    <i class="fa-regular fa-envelope mr-2"></i> Email
                </a>
                <a href="https://wa.me/tu_numero" target="_blank" class="px-8 py-4 border border-neutral-700 rounded-full hover:border-neutral-400 transition-colors">
                    <i class="fa-brands fa-whatsapp mr-2"></i> WhatsApp
                </a>
            </div>
            <div class="flex justify-center gap-6 mt-12 text-neutral-500">
